...
| Electron Security | https://www.electronjs.org/docs/latest/tutorial/security | Renderer IPC sender validation, navigation, new-window restrictions and CSP | 2026-09-17 | plan-1537 native boundary hardening and remaining CSP assessment |

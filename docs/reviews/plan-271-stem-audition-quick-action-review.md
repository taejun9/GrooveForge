# plan-271-stem-audition-quick-action Review

## Scope

- Added Quick Actions Stem Audition commands for Full Mix, Drums, 808, Synth, and Chords.
- Routed the commands through the existing undoable `applyStemAuditionPad` path.
- Added Stem Audition-specific Quick Actions result metric and follow-up text.

...
- Synth 808/bass track with editable scale-aware grid, 808 Bassline Pads, 808 Glide Pads, 808 Contour Pads, Desktop Keyboard Capture length and glide defaults, mono mode, glide, note chance badges, selected-note move/transpose/copy/paste/duplicate tools, saturation direction, and kick-to-808 sidechain ducking.
...
- Simple synth melody track with editable scale-aware grid, Melody Motif Pads, Melody Accent Pads, Melody Contour Pads, Desktop Keyboard Capture length and velocity defaults, velocity control, note chance badges, and selected-note move/transpose/copy/paste/duplicate tools.

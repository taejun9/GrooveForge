...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Arrangement Arc Pads, Arrangement Focus presets, one-click Drop/Build/Hook Lift moves, per-track mutes, per-block bar lengths, selected-block copy/paste, split/merge controls, and audible energy",

...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Independent Pattern A/B/C variations with copy/clear tools and editable arrangement blocks with audible energy, bar length, duplicate, move, and delete controls",

...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Desktop Keyboard Capture for scale-locked 808/Synth note entry with UI-local length, Synth velocity, and 808 glide defaults",
    ...
    "docs/product/product.md": [
        ...
        "808 Bassline Pads, 808 Glide Pads, 808 Contour Pads, Desktop Keyboard Capture length and glide defaults, mono mode, glide, note chance badges, selected-note move/transpose/copy/paste/duplicate tools, saturation direction, and kick-to-808 sidechain ducking",
        "Simple synth melody track with editable scale-aware grid, Melody Motif Pads, Melody Accent Pads, Melody Contour Pads, Desktop Keyboard Capture length and velocity defaults",
        "kick-to-808 sidechain ducking",
        "sidechain ducking",
    ...
    "docs/quality/rules.md": [
        ...
        "expose the target, key map, and UI-local capture defaults",
        "apply captured-note length plus Synth velocity and 808 glide defaults only to newly captured notes",

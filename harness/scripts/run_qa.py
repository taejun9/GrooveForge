...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Sampling is not a parallel core flow.",
        "Later optional sampling may add audio import, chopping/slicing, pitch/stretch, one-shot mapping, or sampler instruments",
        "rather than beside the core beat-making path",
        ...
        "sampling explanations must not be laid out as a co-equal second product spine.",
        ...
        "Keep sampling mentions structurally subordinate to the beat-making core",
    ...
    "docs/product/product.md": [
        ...
        "Sampling is a later optional extension, not the second core product loop.",
        "Future sampling scope may include audio import, chopping/slicing, pitch/stretch, one-shot mapping, and sampler instruments",
    ...
    "docs/architecture/product-architecture.md": [
        ...
        "Architecture diagrams and draft flows should not place a sampling pipeline beside the composition pipeline as an equal starting path.",

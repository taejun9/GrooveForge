...
TEXT_EXPECTATIONS = {
    ...
    "docs/product/product.md": [
        ...
        "Desktop Keyboard Capture for scale-locked 808/Synth note entry",
        "editable drum velocity, Drum Accent Pads, probability, visible chance badges, microtiming, one-click groove humanization, and hat repeat dynamics",

...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "style-aware Composer Actions for explicit local writing moves with scope/impact/undo previews",
    ...
    "docs/quality/rules.md": [
        ...
        "keep previews informational rather than modal confirmations",

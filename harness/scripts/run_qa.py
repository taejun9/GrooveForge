...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Key-aware chord progression presets with chord add/delete, inversion, and per-chord chance controls",
        ...
        "chord progression presets plus add/delete/inversion/chance controls",
    ...
    "docs/product/product.md": [
        ...
        "kick-to-808 sidechain ducking",
        "sidechain ducking",
        "editable step/root/quality/inversion/length/velocity/chance, visible chance badges, and add/delete controls",

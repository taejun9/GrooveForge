...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "style-aware Composer Actions for explicit local writing moves with scope/impact/undo previews and post-click updated-metric result feedback",
        "Delivery Targets for starter sketch, vocal session, beat-store demo, club demo, and custom outcomes",
        "local Next Move actions that can align the selected target, suggest Pattern Chain when arrangement structure is weak, or apply Master Finish",
    ...
    "docs/quality/rules.md": [
        ...
        "keep previews and result strips informational rather than modal confirmations",

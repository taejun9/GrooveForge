...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "editable scale-aware 808/melody lanes with 808 Bassline Pads, 808 Glide Pads, 808 Contour Pads, Melody Motif Pads, Melody Accent Pads, Melody Contour Pads, note chance badges, and selected-note move/transpose/copy/paste/duplicate tools",
    ...
    "docs/product/product.md": [
        ...
        "808 Bassline Pads, 808 Glide Pads, 808 Contour Pads, Desktop Keyboard Capture degree labels, octave, length, and glide defaults, mono mode, glide, note chance badges, selected-note move/transpose/copy/paste/duplicate tools, saturation direction, and kick-to-808 sidechain ducking",
    ...
    "docs/quality/rules.md": [
        ...
        "keep note clipboard state UI-local and out of saved project schema",

...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Key-aware chord progression presets with Chord Pads, Chord Rhythm Pads, and Chord Voicing Pads for one-click chord color, inversion, length, velocity, and chance shaping, chord add/delete, selected-chord move/copy/paste/duplicate/inversion tools, and per-chord chance controls",
        ...
        "chord progression presets plus Chord Pads, Chord Rhythm Pads, Chord Voicing Pads, add/delete/selected-chord move/copy/paste/duplicate/inversion/chance controls",
    ...
    "docs/product/product.md": [
        ...
        "editable step/root/quality/inversion/length/velocity/chance, visible chance badges, add/delete controls, and selected-chord move/copy/paste/duplicate/inversion tools",
    ...
    "docs/quality/rules.md": [
        ...
        "keep chord clipboard state UI-local and out of saved project schema",

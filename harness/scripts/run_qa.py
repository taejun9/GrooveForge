...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "drum velocity, event chance, chance badges, microtiming, one-click groove humanization, hat repeat dynamics, Desktop Keyboard Capture for scale-locked 808/Synth note entry, and selected-note move/transpose/duplicate tools",

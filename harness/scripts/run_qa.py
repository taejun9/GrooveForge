...
TEXT_EXPECTATIONS = {
    ...
    "docs/quality/rules.md": [
        ...
        "Beat Map work must derive workflow stages, song/pattern metrics, export state, stem state, and action suggestions only from local project state, selected Delivery Target",

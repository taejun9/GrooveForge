...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "drum velocity, event chance, chance badges, microtiming, one-click groove humanization, and hat repeat dynamics",
        "Key-aware chord progression presets with chord add/delete controls and per-chord chance",
        "kick-to-808 sidechain ducking",
        "Independent Pattern A/B/C variations with deterministic Subtle/Hook/Break tools, copy/clear tools, and editable arrangement blocks with audible energy, bar length, duplicate, move, and delete controls",
        ...
        "per-block bar lengths and audible energy",
    ...
    "docs/product/product.md": [
        ...
        "note chance badges, saturation direction, and kick-to-808 sidechain ducking",
        "kick-to-808 sidechain ducking",
        "sidechain ducking",
        "editable step/root/quality/length/velocity/chance, visible chance badges, and add/delete controls",
        ...
        "selected-pattern preview, arrangement block edits, arrangement length, arrangement energy, BPM, mixer, sound, and master changes can be heard without stopping and restarting",

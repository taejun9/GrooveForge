...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Beat Map workflow and producer metrics",
    ...
    "docs/quality/rules.md": [
        ...
        "Beat Map work must derive workflow stages, song/pattern metrics, export state, stem state, and action suggestions only from local project state",

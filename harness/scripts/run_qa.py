...
TEXT_EXPECTATIONS = {
    ...
    "docs/product/product.md": [
        ...
        "Desktop Keyboard Capture for scale-locked 808/Synth note entry with a degree-labeled key map plus UI-local octave, length, Synth velocity, and 808 glide defaults",
        "editable drum velocity, Drum Foundation Pads, Drum Accent Pads, probability, visible chance badges, microtiming, one-click groove humanization, hat repeat dynamics, and selected-drum copy/paste hit tools",

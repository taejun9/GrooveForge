...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Delivery Targets for starter sketch, vocal session, beat-store demo, and club demo outcomes",
        ...
        "local Next Move actions that can suggest Pattern Chain when arrangement structure is weak",
    ...
    "docs/quality/rules.md": [
        ...
        "Delivery Target work must store the selected target in local project state",

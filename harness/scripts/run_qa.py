...
TEXT_EXPECTATIONS = {
    "README.md": [
        ...
        "Basic mixer volume/pan/mute/solo, Mix Balance Pads for one-click editable rough balance, channel low-cut/air EQ, Drive/Glue mix controls, Space send FX",
        ...
        "mixer volume/pan/mute/solo, Mix Balance Pads, channel low-cut/air EQ",

...
function checkResult(result) {
  ...
  check(
    evidence?.modalFocus?.closedDetails?.totalCount === 27 &&
      evidence?.modalFocus?.closedDetails?.initiallyOpenCount === 1 &&
      evidence?.modalFocus?.closedDetails?.closedCount === 26 &&
  ...
  check(
    evidence?.starterLanding?.beginner?.projectTitle === "First Guided Beat" &&
      ...
      evidence?.starterLanding?.beginner?.arrangementMoveControlCount === 2 &&
      evidence?.starterLanding?.beginner?.arrangementMoveReadableLabelCount === 2 &&
      evidence?.starterLanding?.beginner?.arrangementMoveUniqueAccessibleNameCount === 2 &&
      evidence?.starterLanding?.beginner?.arrangementMoveContainedCount === 2 &&
      evidence?.starterLanding?.beginner?.arrangementMoveInternalOverflow === 0 &&
...
child.on("exit", (code, signal) => {
  ...
  console.log("- Closed disclosures: 27 panels, zero closed content/Tab leaks, native Enter reopen/reclose, and unchanged project posture ready");

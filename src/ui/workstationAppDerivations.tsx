/**
 * App이 사용하는 편곡·패턴·스타일·준비도·전달 검토용 파생 모델과 미리보기/결과 요약을 모은 계산 계층이다.
 * 현재 ProjectState를 읽어 카드·우선순위·변경 전후 지표를 만들며, 명시된 apply 함수만 새 불변 프로젝트를 반환한다.
 * 화면 문자열과 실행 규칙이 같은 계산을 공유하도록 해 미리보기와 실제 적용의 불일치를 방지한다.
 */
import {
  ArrowDown,
  ArrowLeft,

/**
 * 검색 가능한 퀵 액션 팔레트와 선택된 명령의 실행·결과 UI를 렌더링하는 React 계층이다.
 * 상위 App이 제공한 명령 그래프를 검색/범위/최근/고정 상태와 결합하고 키보드 포커스 및 실행 후 목적 페이지 이동을 조정한다.
 * 모달 키 처리와 비동기 명령 실패를 국소화해 전역 단축키 중복 실행이나 닫힌 팔레트의 포커스 잔류를 막는다.
 */
import {
  ArrowDown,
  ArrowLeft,

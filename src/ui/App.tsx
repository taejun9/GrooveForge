...
export function App(): ReactElement {
  ...
  return (
    <main className="app-shell">
      ...
      <AudienceSessionReadout summary={audienceSessionReadoutSummary} />

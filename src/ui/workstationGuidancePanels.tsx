/**
 * 첫 비트 안내, 사용자 모드 전환, 세션 점검, 워크플로 내비게이터 등 단계별 제작 가이드를 렌더링한다.
 * 프로젝트·분석에서 계산된 체크 항목을 행동 가능한 카드와 퀵 액션으로 연결하고 실행 결과를 aria-live 영역에 전달한다.
 * 탭 이동과 포커스 복원은 실제 목적 패널이 열린 뒤 수행해 숨은 DOM이나 사라진 카드로 포커스가 가지 않게 한다.
 */
import {
  ArrowDown,
  ArrowRight,

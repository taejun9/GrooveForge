...
기본 첫 세션은 `Guided / 82 BPM / A minor / Lo-fi / 8-bar Starter Sketch`로 시작합니다. Studio 모드는 프로듀서가 Review Queue, Production Snapshot, Mix Coach와 Handoff Pack으로 바로 이동할 수 있는 빠른 경로를 제공합니다.

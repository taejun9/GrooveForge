...
- Independent Pattern A/B/C variations with deterministic Subtle/Hook/Break tools, copy/clear tools, and editable arrangement blocks with per-track mutes, audible energy, bar length, split, merge, duplicate, move, and delete controls.

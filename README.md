...
- Next Move strip that turns readiness/export state into explicit local actions such as Blueprint, Pattern Fill, Hook Lift, Save Slot, and Mix Check.

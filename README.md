...
- Arrangement templates for 8-bar loop, full beat, hook-first, and breakdown song structures with explicit section lengths, plus Arrangement Arc Pads with local Arrangement Arc Preview and Result for one-click full-song energy shaping.

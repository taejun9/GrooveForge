...
- Layer Starter Pads show selected Pattern Drums, 808, Chords, and Synth readiness, then route explicit clicks into existing style-aware Drum Foundation, 808 Bassline, Chord Progression, and Melody Motif paths without adding hidden generation, with a Quick Actions Layer Starter command for applying the current highest-priority missing or thin layer plus direct Drums/808/Chords/Synth starter commands that disable ready layers.
...
- Desktop editing shortcuts, Keyboard Capture, and Quick Actions command search for arrangement playback, Arrangement Block Jump/Cue, Section Locator cueing, Pattern A/B/C cueing, Pattern A/B/C switching, Pattern Use selected-block assignment, selected event deletion, Keyboard Capture toggle, capture target, capture defaults, selected-drum edit tools, selected-note edit tools, selected-chord edit tools, MIDI Input Connect, MIDI Arm/Disarm, save, open, undo, redo, snapshots, blueprints, Delivery Target Align, First Beat Path jump and step jump, Mode Focus jump and card jump, Beat Spine jump/apply and direct card jump/apply, Key Retarget, Style Inspector focus and lane focus, Style Quick Picks, Key Compass focus and card focus, Groove Compass focus and card focus, Pattern DNA focus and card focus, Layer Starter and direct layer starts, Pattern Stack and direct stack pads, Drum Move, 808 Move, Melody Move, Chord Move, Sound Preset and direct preset commands, Drum Kit and direct kit pad commands, Sound Focus and direct focus pad commands, Listening Pass focus and checkpoint focus, Beat Passport focus and metric focus, Production Snapshot focus and metric focus, Finish Checklist focus and card focus, Composer Guide focus, Session Pass focus and card focus, Review Queue focus and issue focus, Export Preflight focus and card focus, Workflow Spotlight focus, pattern fills, Pattern Chain/Chain Expand, Arrangement Template and direct template commands, Arrangement Arc and direct arc pad commands, Arrangement Focus and direct focus preset commands, Stem Audition, Mix Snapshot A/B, Mix Balance and direct balance pad commands, Space FX, mix fixes, master finish, Handoff Next Export, and export, with post-run local result metrics, audition cues, and next checks after explicit command clicks.
...
- Basic mixer volume/pan/mute/solo, mixer channel role readouts, Stem Audition Pads for Full Mix/Drums/808/Synth/Chords solo checks plus Quick Actions Stem Audition commands, Mix Balance Pads with local Mix Balance Preview and Result for one-click editable rough balance plus Quick Actions Mix Balance commands for the current preview target and every direct balance pad, channel low-cut/air EQ, Drive/Glue mix controls, Space send FX with Space FX Pads and Result plus Quick Actions Space FX pad commands, per-stem export level meters, deterministic Mix Coach checks with explicit Mix Fix actions and local Mix Fix Result feedback, Master Finish Pads with local Master Finish Preview and Result for editable demo/vocal/store/club output posture, master preset ceiling, master output role readout, reproducible export peak/RMS/headroom meter, full-mix WAV export, drum/808/synth/chord stem export, and arrangement MIDI export for DAW handoff.

...
- Style-aware Composer Actions for explicit local writing moves with inline scope, impact, and undo previews that route Composer Guide focus into existing undoable Drum Foundation, 808 Bassline, Chord Progression, Melody Motif, Pattern Fill, Pattern Chain, arrangement template, and Master Finish paths without sampling or hidden generation.

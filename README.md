...
- Key-aware chord progression presets with Chord Pads, Chord Rhythm Pads for one-click chord length/velocity/chance shaping, chord add/delete, selected-chord move/duplicate/inversion tools, and per-chord chance controls for fast harmonic sketching.

...
- Kick, snare/clap, hat, 808, chord, and synth melody tracks with editable drum velocity, Drum Accent Pads, event chance, chance badges, microtiming, one-click groove humanization, hat repeat dynamics, 808 Bassline Pads, 808 Glide Pads for one-click length/glide/chance shaping, Desktop Keyboard Capture for scale-locked 808/Synth note entry, Melody Motif Pads, and selected-note move/transpose/duplicate tools.

...
- Independent Pattern A/B/C variations with Pattern Compare cue/use cards, deterministic Subtle/Hook/Break tools, one-click Drum Fill/808 Pickup/Melody Turn tail moves, copy/clear tools, and editable arrangement blocks with one-click Drop/Build/Hook Lift moves, per-track mutes, audible energy, bar length, split, merge, duplicate, move, and delete controls.

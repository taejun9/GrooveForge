...
- Sound presets with local Sound Preset Preview and Result for explicit full-tone preset audition before Apply, Drum Kit Pads with local Drum Kit Preview and Result for one-click built-in kick/clap/hat tone posture, Sound Focus Pads with a local Sound Focus Preview and Result plus a Quick Actions Sound Focus command for the current suggested tone focus, and Studio tone controls for built-in drum, 808, kick-duck sidechain, synth, and chord engines.
